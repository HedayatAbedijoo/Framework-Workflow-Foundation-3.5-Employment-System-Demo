CREATE OR REPLACE PACKAGE WORKFLOW_TRACKING_PKG AS
	...
	/*
	 * Retrieve tracking data for the specified instance identifier
	 */
	PROCEDURE GetWorkflow
	(
		p_INSTANCE_ID IN WORKFLOW_INSTANCE.INSTANCE_ID%TYPE
		,p_TRACKING_WORKFLOW_INSTANCES OUT RefCursor
	);
	
	/*
	 * Retrieve tracking data for any workflows called by the specified
	 * instance identifier
	 */
	PROCEDURE GetInvokedWorkflows
	(
		p_CALLER_INSTANCE_ID IN WORKFLOW_INSTANCE.CALLER_INSTANCE_ID%TYPE
		,p_TRACKING_WORKFLOW_INSTANCES OUT RefCursor
	);
	
	/*
	PROCEDURE GetWorkflows
	(
		p_START_DATE IN WORKFLOW_INSTANCE.INITIALISED_DATE_TIME%TYPE := NULL
		,p_END_DATE IN WORKFLOW_INSTANCE.END_DATE_TIME%TYPE := NULL
		,
	*/
