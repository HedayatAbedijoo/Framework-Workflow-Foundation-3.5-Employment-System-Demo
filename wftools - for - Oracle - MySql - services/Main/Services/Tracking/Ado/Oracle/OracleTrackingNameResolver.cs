...
namespace WFTools.Services.Tracking.Ado.Oracle
{
    /// <summary>
    /// Oracle specific implementation of <see cref="ITrackingNameResolver" />.
    /// </summary>
    public class OracleTrackingNameResolver : ITrackingNameResolver
    {
        /// <summary>
