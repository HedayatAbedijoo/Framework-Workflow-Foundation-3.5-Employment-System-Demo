...
namespace WFTools.Services.Tracking.Ado.Configuration
{
    ...
    {
        private const String _configurationSectionName = "wftools.services.tracking.ado";
        ...
        {
            return (TrackingAdoProviderSettings)ConfigurationManager.GetSection(_configurationSectionName);
        }
