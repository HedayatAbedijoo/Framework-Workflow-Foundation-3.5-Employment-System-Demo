...
namespace WFTools.Services.Common.Ado.Configuration
{
    ...
    {
        private const String _configurationSectionName = "wftools.services.common.ado";
        ...
        {
            return (CommonAdoProviderSettings)ConfigurationManager.GetSection(_configurationSectionName);
        }
