...
namespace WFTools.Services.Common.Ado
{
    ...
    public class DefaultAdoResourceProvider : IAdoResourceProvider
    {
        ...
        public virtual void Initialise(ConnectionStringSettings connectionStringSettings)
        {
            ...
            DbConnectionStringBuilder dbConnectionStringBuilder = _dbProviderFactory.CreateConnectionStringBuilder();
            ...
            // check to make sure we can connect to the database
        ...
        /// <summary>
        /// Gets the  connection string settings used to initialise the resource provider.
        /// </summary>
        ...
        /// <summary>
        /// Gets/sets the name of the ADO.NET provider for which we provide resources for.
        /// </summary>
        ...
        /// </returns>
        public virtual DbConnection CreateEnlistedConnection(Transaction transaction, out Boolean shouldClose)
        {
            if (transaction == null)
        ...
        /// </remarks>
        protected virtual Boolean SupportCursors
        {
            get { return false; }
        }
