...
{
    /// <summary>
    /// MySQL specific implementation of <see cref="IAdoValueReader" />.
    /// </summary>
    /// <remarks>
    /// This implementation modifies the GUID retrieval functionality
    /// to use a string instead.
    /// </remarks>
    public class MySqlValueReader : DefaultAdoValueReader
    {
        /// <summary>
        ...
        /// </summary>
        public override Guid GetGuid(IDataRecord dataRecord, Int32 ordinal, Guid defaultValue)
        {
            if (dataRecord == null)
                throw new ArgumentNullException("dataRecord");
