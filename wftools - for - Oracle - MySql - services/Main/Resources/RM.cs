...
public static class RM
{
    ...
    public static string Get_Error_CannotConvertColumnToGuid()
    {
        return getString("Error_CannotConvertColumnToGuid");
    }

    public static string Get_Error_CannotConvertParameterToGuid()
    {
        return getString("Error_CannotConvertParameterToGuid");
    }
