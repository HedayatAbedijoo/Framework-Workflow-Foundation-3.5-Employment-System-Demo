...
namespace WFTools.Services.Common.Ado
{
    ...
    public class DefaultAdoValueReader : IAdoValueReader
	{
        ...
        protected virtual Int32 GetOrdinal(IDataRecord dataRecord, String columnName)
        {
            ...
            {
                throw new ArgumentException(String.Format("The specified column name '{0}' does not exist within dataRecord", columnName), "columnName");
            }
        }
        ...
        public virtual T GetEnum<T>(IDataRecord dataRecord, Int32 ordinal) where T : struct
        {
            ...
            if (dataRecord.IsDBNull(ordinal))
                throw new ArgumentException("Cannot convert DBNull.Value to enum value.");
            else
            {
                ...
                if (Enum.IsDefined(typeof(T), enumValue))
                    ...
                    throw new ArgumentException("Cannot convert value to enum.");
            }
        }
        ...
        public virtual Guid GetGuid(IDataRecord dataRecord, Int32 ordinal)
        {
            ...
            if (dataRecord.IsDBNull(ordinal))
                throw new InvalidCastException("Cannot convert DBNull.Value to Guid");
            else
        ...
        {
            if (parameterValue == null || parameterValue == DBNull.Value)
                throw new ArgumentException("Cannot convert DBNull.Value to Int32 value.");
        ...
        {
            if (parameterValue == null || parameterValue == DBNull.Value)
                throw new ArgumentException("Cannot convert DBNull.Value to Int64 value.");

            return (Int64) parameterValue;
        }
        ...
        {
            if (parameterValue == null || parameterValue == DBNull.Value)
                throw new ArgumentException("Cannot convert DBNull.Value to Int16 value.");

            return (Int16) parameterValue;
        }
        ...
        {
            if (parameterValue == null || parameterValue == DBNull.Value)
                throw new ArgumentException("Cannot convert DBNull.Value to Byte value.");
        ...
        {
            if (parameterValue == null || parameterValue == DBNull.Value)
                throw new InvalidCastException("Cannot convert DBNull.Value to Single value.");

            return (Single) parameterValue;
        }
        ...
        {
            if (parameterValue == null || parameterValue == DBNull.Value)
                throw new InvalidCastException("Cannot convert DBNull.Value to Double value.");
        ...
        {
            if (parameterValue == null || parameterValue == DBNull.Value)
                throw new InvalidCastException("Cannot convert DBNull.Value to Decimal value.");
        ...
        {
            if (parameterValue == null || parameterValue == DBNull.Value)
                throw new InvalidCastException("Cannot convert DBNull.Value to Boolean value.");
        ...
        {
            if (parameterValue == null || parameterValue == DBNull.Value)
                throw new InvalidCastException("Cannot convert DBNull.Value to DateTime value.");
