...
namespace HA.Workflow.Services.Controls.SubWorkflow
{
    [Designer(typeof(SubWorkflowDesigner), typeof(IDesigner))]
    public partial class SubWorkflowActivity : Activity
    {

        public SubWorkflowActivity()
        {
            base.SetReadOnlyPropertyValue(SubWorkflowActivity.ParametersProperty, new WorkflowParameterBindingCollection(this));
        ...
        public static DependencyProperty TypeProperty = System.Workflow.ComponentModel.DependencyProperty.Register("Type", typeof(Type), typeof(SubWorkflowActivity), new PropertyMetadata(DependencyPropertyOptions.Metadata));
        ...
        public Type Type
        {
            get
            {
                return ((Type)(base.GetValue(SubWorkflowActivity.TypeProperty)));
            }
            set
            {
                base.SetValue(SubWorkflowActivity.TypeProperty, value);
            }
        }
        public static DependencyProperty ParametersProperty = System.Workflow.ComponentModel.DependencyProperty.Register("Parameters", typeof(WorkflowParameterBindingCollection), typeof(SubWorkflowActivity), new PropertyMetadata(DependencyPropertyOptions.Metadata | DependencyPropertyOptions.ReadOnly));
        ...
        public WorkflowParameterBindingCollection Parameters
        {
            get
            {
                return ((WorkflowParameterBindingCollection)(base.GetValue(SubWorkflowActivity.ParametersProperty)));
            }
