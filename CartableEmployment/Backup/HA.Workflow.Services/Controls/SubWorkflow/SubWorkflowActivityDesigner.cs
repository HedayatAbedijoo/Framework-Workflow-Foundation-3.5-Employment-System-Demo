...
namespace HA.Workflow.Services.Controls.SubWorkflow
{
    ...
    public class SubWorkflowDesigner : ActivityDesigner
    {
        ...
        protected override void PreFilterProperties(IDictionary properties)
        {
            ...
            SubWorkflowActivity a = this.Activity as SubWorkflowActivity;
            if (a.Type != null)
            {
    ...
    public class CallWorkflowParameterBindingPropertyDescriptor : PropertyDescriptor
    {
        ...
        public override Type ComponentType
        {
            get
            {
                ...
                return typeof(SubWorkflowActivity);
            }
        }

        public override object GetValue(object component)
        {
            WorkflowParameterBindingCollection parameters = ((SubWorkflowActivity)component).Parameters;
